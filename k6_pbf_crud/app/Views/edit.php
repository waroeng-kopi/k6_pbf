...
<main class="min-h-screen mx-5">
  <div class="flex flex-row justify-between my-5">
    <div class="flex flex-row my-auto items-center gap-2 px-4 py-3 rounded-lg bg-blue-700 text-white" id="tambahButton">
    ...
    <div id="formWrapper" style="display: none;">
      <form method="post" action="<?= base_url('Home/create') ?>">
        ...
        <input type="text" name="namaMobil" placeholder="Nama Mobil">
        <input type="text" name="penyewa" placeholder="Penyewa">
        <input type="text" name="jamSewa" placeholder="Jam Sewa">
          ...
          <?php foreach ($isi_sewa as $row) : ?>
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <td class="px-6 py-4 flex flex-row gap-x-1">
                <a href="/edit?id=<?= $row->sewaId ?>" class="font-medium py-2 px-3 bg-yellow-500 text-white rounded-lg hover:underline">Edit</a>
