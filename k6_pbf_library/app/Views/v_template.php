...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="/" class="navbar-brand">
        <img src="<?= base_url('assets') ?>/miniLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <footer class="main-footer text-center">
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 <a href="https://github.com/waroeng-kopi">waroeng-kopi</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
